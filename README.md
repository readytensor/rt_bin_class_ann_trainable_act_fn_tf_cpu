# ANN with Trainable Activation Function Classifier in TensorFlow (CPU) with Shapley Explanations
## Project Description
...
- A **ANN with Trainable Activation Function** classifier built using **TensorFlow**. The model runs on CPU.
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the ANN with Trainable Activation Function classifier model implemented using TensorFlow.
